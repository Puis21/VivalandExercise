...
void AFireRatePickup::OnSphereOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
	...
	if (TankCharacter)
	{
		...
		if (Buff)
		{
			Buff->BuffFireRate(FireRateBuff, FireRateBuffTime);
		}
	}
