...
#include "TankProject/HUD/OverheadWidget.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeOverheadWidget() {}
// Cross Module References
	ENGINE_API UClass* Z_Construct_UClass_APawn_NoRegister();
	TANKPROJECT_API UClass* Z_Construct_UClass_UOverheadWidget();
	TANKPROJECT_API UClass* Z_Construct_UClass_UOverheadWidget_NoRegister();
...
// End Cross Module References
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_GetPlayerNameTimeout_MetaData[];
#endif
		static const UECodeGen_Private::FFloatPropertyParams NewProp_GetPlayerNameTimeout;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_GetPlayerNameInterval_MetaData[];
#endif
		static const UECodeGen_Private::FFloatPropertyParams NewProp_GetPlayerNameInterval;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UOverheadWidget_Statics::NewProp_GetPlayerNameTimeout_MetaData[] = {
		{ "AllowPrivateAccess", "TRUE" },
		{ "Category", "Overhead Widget Properties" },
		{ "ModuleRelativePath", "HUD/OverheadWidget.h" },
		{ "Units", "Seconds" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UOverheadWidget_Statics::NewProp_GetPlayerNameTimeout = { "GetPlayerNameTimeout", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UOverheadWidget, GetPlayerNameTimeout), METADATA_PARAMS(Z_Construct_UClass_UOverheadWidget_Statics::NewProp_GetPlayerNameTimeout_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOverheadWidget_Statics::NewProp_GetPlayerNameTimeout_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UOverheadWidget_Statics::NewProp_GetPlayerNameInterval_MetaData[] = {
		{ "AllowPrivateAccess", "TRUE" },
		{ "Category", "Overhead Widget Properties" },
		{ "ModuleRelativePath", "HUD/OverheadWidget.h" },
		{ "Units", "Seconds" },
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UOverheadWidget_Statics::NewProp_GetPlayerNameInterval = { "GetPlayerNameInterval", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UOverheadWidget, GetPlayerNameInterval), METADATA_PARAMS(Z_Construct_UClass_UOverheadWidget_Statics::NewProp_GetPlayerNameInterval_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOverheadWidget_Statics::NewProp_GetPlayerNameInterval_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UOverheadWidget_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UOverheadWidget_Statics::NewProp_GetPlayerNameTimeout,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UOverheadWidget_Statics::NewProp_GetPlayerNameInterval,
	};
	...
	template<> TANKPROJECT_API UClass* StaticClass<UOverheadWidget>()
	{
		return UOverheadWidget::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UOverheadWidget);
	UOverheadWidget::~UOverheadWidget() {}
	struct Z_CompiledInDeferFile_FID_Users_GenTl_OneDrive_Documents_GitHub_VivalandExercise_TankProject_Source_TankProject_HUD_OverheadWidget_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_GenTl_OneDrive_Documents_GitHub_VivalandExercise_TankProject_Source_TankProject_HUD_OverheadWidget_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOverheadWidget, UOverheadWidget::StaticClass, TEXT("UOverheadWidget"), &Z_Registration_Info_UClass_UOverheadWidget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOverheadWidget), 3562129983U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_GenTl_OneDrive_Documents_GitHub_VivalandExercise_TankProject_Source_TankProject_HUD_OverheadWidget_h_3637176843(TEXT("/Script/TankProject"),
		Z_CompiledInDeferFile_FID_Users_GenTl_OneDrive_Documents_GitHub_VivalandExercise_TankProject_Source_TankProject_HUD_OverheadWidget_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_GenTl_OneDrive_Documents_GitHub_VivalandExercise_TankProject_Source_TankProject_HUD_OverheadWidget_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
